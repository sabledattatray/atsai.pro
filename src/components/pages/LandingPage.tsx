        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
             ...
             <div className="p-8 bg-[#0b0f19]/40 border border-white/5 rounded-2xl shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group backdrop-blur-md">
                ...
                <h3 className="font-bold text-lg mb-3 text-white"><Link href="/seo/resume-score-python-developer" className="hover:text-indigo-400 transition-colors">View Sample Reports</Link></h3>
              ...
              <AnimatePresence mode="popLayout">
                {displayedTemplates.length > 0 ? (
                  displayedTemplates.map((template) => (
                    ...
                    >
                      <Link 
                        href={`/cover-letters/${slugify(template)}`} 
