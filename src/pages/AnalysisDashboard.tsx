        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="relative bg-[#0d1325]/95 w-full max-w-lg rounded-2xl shadow-2xl border border-white/10 overflow-hidden backdrop-blur-xl">
                ...
                <div className="p-3 space-y-1">
                    ...
                    <Link to="/cover-letter-builder" onClick={() => setShowCmd(false)} className="flex items-center px-3 py-2 text-xs text-slate-300 hover:bg-white/5 rounded-xl cursor-pointer transition-colors">
                    ...
                    <Link to="/templates" onClick={() => setShowCmd(false)} className="flex items-center px-3 py-2 text-xs text-slate-300 hover:bg-white/5 rounded-xl cursor-pointer transition-colors">
